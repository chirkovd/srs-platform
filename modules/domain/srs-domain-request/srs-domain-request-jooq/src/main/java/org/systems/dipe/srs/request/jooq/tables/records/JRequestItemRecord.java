...
public class JRequestItemRecord extends UpdatableRecordImpl<JRequestItemRecord> implements Record5<UUID, UUID, UUID, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public JRequestItemRecord values(UUID value1, UUID value2, UUID value3, LocalDateTime value4, LocalDateTime value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JRequestItemRecord(UUID itemId, UUID requestId, UUID targetId, LocalDateTime approved, LocalDateTime created) {
        super(JRequestItem.REQUEST_ITEM);
