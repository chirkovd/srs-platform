...
public class JEventRecord extends UpdatableRecordImpl<JEventRecord> implements Record7<Integer, String, String, JSONB, String, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row7<Integer, String, String, JSONB, String, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public JEventRecord value4(JSONB value) {
        setMessage(value);
        return this;
    }
    ...
    @Override
    public JEventRecord values(Integer value1, String value2, String value3, JSONB value4, String value5, LocalDateTime value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JEventRecord(Integer eventId, String status, String type, JSONB message, String error, LocalDateTime retryAt, LocalDateTime created) {
        super(JEvent.EVENT);
